...
namespace TheBoyKnowsClass.Common.UI.WPF.Modern.Controls
{
    ...
    ///
    ///     <MyNamespace:ModernMessageBoxControl/>
    ///
    /// </summary>
    public class ModernMessageBoxControl : Control
    {
        static ModernMessageBoxControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ModernMessageBoxControl), new FrameworkPropertyMetadata(typeof(ModernMessageBoxControl)));
        }
    }
}
