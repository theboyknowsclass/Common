...
namespace TheBoyKnowsClass.Common.UI.WPF.Models
{
    public class UserAccountContoller
    {
        ...
        public static bool IsProcessAdmin
        {
            get
            {
        ...
        public static BitmapSource GetShieldBitmap()
        {
            ...
            if (Environment.OSVersion.Version.Major >= 6)
            {
                ...
                shieldSource = System.Windows.Interop.Imaging.CreateBitmapSourceFromHIcon(sii.hIcon, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
            }
            else
            {
